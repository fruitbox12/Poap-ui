  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        {!address ? (
          <VStack gap={2}>
            <h1 className={styles.title}>Welcome to Circlepay</h1>
            <Text className={styles.subtitle}>Seamless Account Tokenization</Text>
          ...
          <HStack gap={2} className={styles.selectionContainer}>
            <VStack className={styles.containerLeft}>
              <Text fontSize="1.5rem" w="400px">
                Already have published Circlepay NFTs to manage?
              </Text>
              <Spacer h="10px"></Spacer>
              <Link href={`/dashboard`}>
            ...
            <VStack className={styles.containerRight}>
              <Text fontSize="1.5rem" w="400px">
                Launch a Badge for your Circlepay event
              </Text>
              <Spacer h="10px"></Spacer>
              <Link href={`/builder`}>
